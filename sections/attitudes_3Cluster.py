...
def render(_):
    ...
    **Legend**  
    ...
    Our Clustering results in 3 Cluster:
    Cluster 0: Germany, Australia, France and United Kingdom.What stands out is the developed status of these countries.
    Cluster 1: USA, Singapore, Brasil, United Arab Emirates and China. These countries are emerging countries or at least strongly growing countries.
    Cluster 2: Only consists of South Korea. As their attitudes towards vacation is very different. 
